...
public class BookDemo {
    ...
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            System.out.println("You have " + yourLibrary.numberOfBooksInLibrary());
        }

        else if (choice == 2) {
            Book newBook = new Book();
            String bookInfo = userInput.nextLine();
            ...
            Book[] yourBookArray = new Book[10];
            yourBookArray[0] = newBook;

            System.out.println(yourBookArray);
